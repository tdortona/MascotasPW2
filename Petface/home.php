	         ...
	         <?php
				...
				{	
					...
					{	
						...
						echo "<div class='row'>";
							...
							echo "<div class='col-sm-4'>";
								echo "<div class='imgComent'>";
									...
									echo "<a href='".htmlspecialchars("perfilMascota.php?nombreMascota=".$row["mascotaId"])."'><b>".$row["nombreMascota"]."</b></a>";
						...
						echo "	<div id='publicacion".$row["idPublicacion"]."' class='form-group botones'>
									<input id='meGusta".$row["idPublicacion"]."' class='btn btn-primary boton' type='button' value='".$tipoMeGusta."' onclick='meGusta(".$row["idPublicacion"].",".$idUsuario.",".$row["mascotaId"].")'>
									</input>
									<input id='noMeGusta".$row["idPublicacion"]."' class='btn btn-primary boton' type='button' value='".$tipoNoMeGusta."' onclick='noMeGusta(".$row["idPublicacion"].",".$idUsuario.",".$row["mascotaId"].")'>																		
									</input>
								</div>";
							...
							{	
								...
								echo "<div class='row'>";    	
									echo "<div class='col-sm-8'>";
										echo "<div class='imgComent'>";
											echo "<img src='logica/"./*ruta de la imagen de la fila*/$row["mascotaImagen"]."' class='img-circle' height='55' width='55' alt='Avatar'> <a href='".htmlspecialchars("perfilMascota.php?nombreMascota="./*id de la mascota de la fila para pasarlo en la url de perfilMascota.php*/$row["mascotaId"])."'><b>"./*nombre de la mascota del registro*/$row["mascotaNombre"]."</b></a> \n";
											echo "<br>";
											echo "<div class='col-sm-10'>";
												echo "<div class='col-sm-4'>";
