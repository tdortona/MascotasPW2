<!-- php para seguir el perfil de una mascota -->
<?php
  ...
  //insert para insertar en la tabla seguidor usando en el where la variable idMascota y la variable idUsuario
  $sql2= "INSERT INTO seguidor VALUES ('$idUsuario','$idMascota')";
